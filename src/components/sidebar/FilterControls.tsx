  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
        <span style={{ fontSize: 10, color: '#475569', fontWeight: 600, width: 52, flexShrink: 0 }}>
          Correct
        </span>
          ...
          {(
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                fontWeight: 600,
                background: filters.correct === v ? CB.blue : '#f1f5f9',
                color: filters.correct === v ? '#fff' : '#475569',
                border: filters.correct === v ? 'none' : '1px solid #cbd5e1',
              }}
            >
              {l}
            </button>
      ...
      {filterOpts.views.length > 1 && (
        <div style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
          <span
            style={{ fontSize: 10, color: '#475569', fontWeight: 600, width: 52, flexShrink: 0 }}
          >
            View
          </span>
          <select
      ...
      {selCount >= 2 && selCount <= 4 && (
        ...
        >
          ⚖️ Compare {selCount} rows side-by-side
        </button>
      )}
    </div>
  );
